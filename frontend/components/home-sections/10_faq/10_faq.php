  ...
  <section class="faq-section" id="faq-block">
    <style>
      /* Luxury Dark Theme for FAQ Section matching EV Tech background flow */
      .faq-section {
        border-top: none;
        margin-top: 0;
      ...
      .faq-editorial-desc {
        font-size: 14.5px;
        line-height: 1.6;
        color: #cbd5e1; /* Readable silver gray */
        font-family: 'Montserrat', sans-serif;
        margin: 0;
      }
      .faq-editorial-visual {
        background: rgba(255, 255, 255, 0.02); /* Glass container */
      ...
      .faq-question-wrap {
        ...
        font-size: 15px;
        font-weight: 700;
        color: #ffffff; /* Crisp white questions */
        font-family: 'Montserrat', sans-serif;
      }
      .faq-num-badge {
        font-family: 'Montserrat', sans-serif;
      ...
      .faq-content-inner {
        ...
        font-size: 14px;
        line-height: 1.6;
        color: #94a3b8; /* High-contrast readable gray */
        font-family: 'Montserrat', sans-serif;
      }
      ...
      @media (max-width: 768px) {
        ...
        .faq-radar-svg {
          height: 140px !important; /* Mobile friendly height */
        }
        .faq-trigger {
    ...
    <div class="container">
      <div class="faq-split-container">
        ...
        <div class="faq-editorial-block">
          <div class="section-header faq-mobile-center-header" style="margin-bottom: 0; padding-bottom: 0;">
            <span class="section-tag" style="margin-bottom: 8px;">Góc tư vấn</span>
          ...
          <div class="faq-editorial-visual">
            ...
            <div class="faq-radar-container">
              <svg class="faq-radar-svg" viewBox="0 0 200 200" width="100%">
                <!-- Grid background -->
                <line x1="0" y1="100" x2="200" y2="100" stroke="rgba(0, 210, 255, 0.08)" stroke-width="1" />
            ...
            <div class="faq-visual-item" style="border-top: 1px solid rgba(255,255,255,0.08); padding-top: 20px; display: flex; flex-direction: column; align-items: flex-start; gap: 20px; width: 100%;">
              <div style="display: flex; gap: 15px; align-items: center; width: 100%;">
                ...
                <div style="flex-grow: 1;">
                  <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px; margin-bottom: 4px;">
                    <strong style="color: #ffffff; font-size: 14.5px; font-weight: 800; letter-spacing: 0.5px;">TƯ VẤN KỸ THUẬT 24/7</strong>
                    <span style="display: inline-flex; align-items: center; gap: 4px; background: rgba(129, 199, 132, 0.15); border: 1px solid rgba(129, 199, 132, 0.3); padding: 2px 8px; border-radius: 12px; font-size: 9px; color: #81c784; font-weight: 700; letter-spacing: 0.5px;">
                      <span style="width: 5px; height: 5px; background: #81c784; border-radius: 50%; display: inline-block; box-shadow: 0 0 8px #81c784; animation: faq-core-pulse 1.5s ease-in-out infinite;"></span>
                      ONLINE
                    </span>
                  </div>
                  <span class="faq-visual-desc" style="color: #94a3b8; font-size: 12.5px; line-height: 1.5; display: block;">Liên hệ trực tiếp với Cố vấn kỹ thuật của VinFast qua Hotline hoặc Zalo để được giải đáp tức thì.</span>
                </div>
              </div>
